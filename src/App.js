...
import './App.css'; // optional, styles included inline below
// import Lottie from 'lottie-react';
// import rotatingEarth from '@/assets/rotating-earth.json'; 

// ---- MOCK DATA ----
const initialRooms = [
  { id: 1, name: 'Conference Hall', capacity: 10 },
  { id: 2, name: 'Power Meeting Room', capacity: 6 },
  { id: 3, name: 'Hanger Bay room', capacity: 20 },
  { id: 4, name: 'Engineer Hub', capacity: 12 },
];
...
// Available time slots (you can expand)
const TIME_SLOTS = [
  '09:00-10:00',
  '10:00-11:00',
  '11:00-12:00',
...
function App() {
  ...
  const handleAddBooking = () => {
    ...
    // Check for double booking (same room, date, timeSlot)
  ...
  // Open modal for a specific room
